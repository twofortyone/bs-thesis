\begin{table}
    ...
    \hline
    \multicolumn{1}{c}{\begin{tabular}[c]{@{}c@{}}\textbf{Faulted }\\\textbf{line}\end{tabular}} & \multicolumn{1}{c}{\textbf{Actions}} & \textbf{n(A)} & \textbf{T [s]} & \textbf{n(IL)} & \textbf{n(IL)} & \multicolumn{1}{c|}{\textbf{RR}}  \\ 
    \hline
